      ...
      <ScrollView>
        <View style={styles.container}>
          <View style={{flex: 1, flexDirection: 'row',margin:10}}>
            ...
            <View style={{flex: 0.05, flexDirection: 'column'}}>
              <Icon
                ...
                size={20}
                color="red"
                onPress={() => this.props.openBioModal()}
              />
            </View>
          </View>
          {/* <TextInput
          ...
          <FlatList
            ...
            renderItem={({item}) => this.renderSingleSchedule(item)}
        ...
        {this.state.addSLotModal ? (
          <AddSlotModal
            isVisible={this.state.addSLotModal}
            closeModal={this.closeModal}
            user={this.props.user}
            slots={this.state.slots}
            updateSlots={this.props.slotUpdate}
            updateSlotsLocal={this.slotUpdateLocal}
          />
        ) : null}
      </ScrollView>
    );
